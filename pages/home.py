...
def add_logo_with_rotating_text():
    # Update path to use proper asset directory structure
    img_path = "asset/images/chef.png"  # Adjust this to match your actual logo path
    try:
    ...
    <div style="display: flex; justify-content: center; width: 100%; margin-bottom: 2rem;">
        <div style="width: 400px; height: 400px; position: relative;">
            <style>
                ...
                .logo-container:hover .rotating-text {{
            ...
            <div class="svg-container">
                <svg viewBox="0 0 400 400" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <!-- Remove the background circle to keep center transparent -->
